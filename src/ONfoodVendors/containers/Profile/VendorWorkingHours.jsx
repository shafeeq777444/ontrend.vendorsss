...
export default function BusinessHoursCard({ workingDays: initialWorkingDays, dayWiseOpenAndClosingTime, vendorId, openingTime, closingTime }) {
  const { mutate: updateVendorProfile, isPending } = useUpdateVendorProfile();

  const [mode, setMode] = useState(
    Object.keys(dayWiseOpenAndClosingTime || {}).length === 0 ? "general" : "custom"
  );
