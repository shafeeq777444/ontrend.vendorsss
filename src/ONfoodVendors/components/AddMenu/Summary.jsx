        ...
        <div className="bg-white rounded-lg p-4 space-y-3">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">{formatPrice(formData.offerPrice)}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="bg-white rounded-lg p-4 space-y-3">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{formatTime(formData.avilableStartTime)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Available Until:</span>
              <span className="font-medium">{formatTime(formData.avilableEndTime)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Preparation Time:</span>
              <span className="font-medium">{formData.prepearationTime ? `${formData.prepearationTime} min` : 'Not set'}</span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            {Object.entries(formData.addOn).map(([groupName, items]) => (
              <div key={groupName} className="bg-gray-50 rounded-lg p-3">
                <div className="font-medium text-sm text-gray-800 mb-2">{groupName}</div>
                {items.length > 0 ? (
